...
public record MentionParser(TextNode style, ServerPlaceholderContext context) implements NodeParser {
    ...
    public TextNode[] parseInput(String input) {
        ...
        for (ServerPlayer player : context.server().getPlayerList().getPlayers()) {
            ...
            if (startPos != -1) {
                ...
                TextNode mention = new DirectComponentNode(style.toComponent(ServerPlaceholderContext.of(player)));
